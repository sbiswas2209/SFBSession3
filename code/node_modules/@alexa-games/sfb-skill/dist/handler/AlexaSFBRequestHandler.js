...
exports.SFBRequestHandler = void 0;
...
class SFBRequestHandler {
    ...
    async handle(handlerInput) {
        ...
        let storyDriver = new sfb_f_1.SFBDriver(storyData, customImportPlugins, this.customExtensions, this.config.pollyVoiceConfig, this.config.locale);
