 ...
 */
export declare class LocalizationExtension implements ImporterExtension {
    private locale;
    private languageString;
    private overwrite;
    private srcLocale;
    constructor(locale: string, languageString: LanguageStrings, overwrite?: boolean, srcLocale?: string);
    ...
    getLocalizedStringsObject(): LanguageStrings;
    private updateLanguageString;
}
