...
import { InstructionExtension, ImporterExtension, DriverExtension } from '../extensions/SFBExtension';
import { PlayStage } from './PlayStage';
import { AudioFileAccessor, PollyUtil } from '@alexa-games/sfb-polly';
import { AudioItemUtil } from './AudioItemUtil';
declare type SFBExtensionType = ImporterExtension | DriverExtension | InstructionExtension;
...
export declare class SFBDriver {
    ...
    private callStack;
    historySize: number;
    constructor(storyMetadata: StoryMetadata, customImportPlugins?: ABCImportPlugin[], extensions?: SFBExtensionType[], pollyConfiguration?: DriverPollyConfig, locale?: string, audioAccessor?: AudioFileAccessor, pollyUtil?: PollyUtil);
    /**
